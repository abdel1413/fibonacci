...
//  a) loop thru each sub array
 // b) inside the loop, create an empty array where to push each el from sub array 
// 2: reverse each row of transposed matrix
  //a) loop thru the outer (entire) array  backwardly
  // b) access each elt base of the sub array index 
  // push into an empty array created earlier
  // finally push the reversed array into new empty array and return it;
